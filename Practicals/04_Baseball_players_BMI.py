...
Again, both are available as regular Python lists: 
...
Python code to convert height_in to a numpy array with the correct units is already 
available in the workspace. Follow the instructions step by step and finish the game!
"""
